...
class GracefulDegradationManager:
    ...
    def _detect_new_topic_heuristic(self, session: SessionState, user_message: str) -> bool:
        ...
        topic_indicators = [
            "новая тема", "другая тема", "сменим тему", "давай о",
            "расскажи о", "что такое", "объясни что такое"
        ]
        
        message_lower = user_message.lower()
        return any(indicator in message_lower for indicator in topic_indicators)
    
    def _detect_new_question_heuristic(self, session: SessionState, user_message: str) -> bool:
