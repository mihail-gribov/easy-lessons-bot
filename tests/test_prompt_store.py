...
class TestPromptStoreIntegration:
    ...
    def test_full_workflow(self):
        ...
        session.add_message("bot", "Photosynthesis is how plants make food using sunlight.")
        ...
        assert "science" in system_msg["content"] or any("science" in msg["content"] for msg in messages if msg["role"] == "system")
